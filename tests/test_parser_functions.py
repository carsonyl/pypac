...
@pytest.mark.parametrize('host,expected_value', [
    ('www.google.com', True),
...
@pytest.mark.parametrize('host,pattern,mask,expected_value', [
...
@pytest.mark.parametrize('host,hostdom,expected_value', [
...
@pytest.mark.parametrize('url,pattern,expected_value', [
